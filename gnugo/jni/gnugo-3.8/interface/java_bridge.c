...
JNIEXPORT void JNICALL Java_lrstudios_games_gnugo_GnugoBot_initGtp (JNIEnv* env, jclass clasz, jfloat memory)
{
	init_gtp (memory);
}


JNIEXPORT jstring JNICALL Java_lrstudios_games_gnugo_GnugoBot_playGtp (JNIEnv* env, jclass clasz, jstring input)
{
